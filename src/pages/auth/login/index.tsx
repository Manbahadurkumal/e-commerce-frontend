...
const LoginPage = () =>{
  ...
  const loginDto = Yup.object({
    email: Yup.string().email().required("Email is compulsary"),
...
// Wer are using local Storage instead of cookies
        localStorage.setItem("accessToken",response.result.token.accessToken) // using local storeage to store
