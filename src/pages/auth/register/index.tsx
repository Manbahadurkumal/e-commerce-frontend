...
const RegisterPage = () =>{
  ...
  const {control,setValue, handleSubmit, formState: {errors}} = useForm({
    resolver: yupResolver(rules) // this is binding package between yup and
  });
    ...
    <section className="bg-white">
      <div className="lg:grid lg:grid-cols-12">
        ...
        <form onSubmit={handleSubmit(submitEvent)} className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6 sm:col-span-3">
            <label htmlFor="PasswordConfirmation" className="block text-sm font-medium text-gray-700"> Password Conformation </label>
