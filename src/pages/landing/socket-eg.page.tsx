...
const SocketExample = ()=>{
    ...
    const submitData = (e:any) =>{
        e.preventDefault()
        socket.timeout(5000).emit("new-messave", value)
    }
    return (<>
    <div className="m-20">
    {
        ...
        className="border-2 px-3 py-2 border-green-800 rounded bg=green-700 text-white hover: bg-green-500 hover: border-green-500">Disconnect</button>
        </>: <button
    ...
    <form onSubmit={submitData}>
        ...
        <button
            className="border-2 px-3 py-2 border-green-800 rounded bg=green-700 text-white hover: bg-green-500 hover: border-green-500">
        Submit
        </button>
